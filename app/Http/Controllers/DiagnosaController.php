...
class DiagnosaController extends Controller
{
    ...
    //     // Mendapatkan daftar penyakit berdasarkan hasil diagnosa
    //     $hasil_diagnosa = $result['hasil_diagnosa'];
    //     $penyakit_ids = array_keys($hasil_diagnosa);

    //     // Mendapatkan data solusi dari tabel penyakit berdasarkan id penyakit
    //     $solusi_penyakit = Penyakit::whereIn('id', $penyakit_ids)->pluck('solusi', 'id');

    //     // Memasukkan data solusi ke dalam array hasil diagnosa
    //     foreach ($hasil_diagnosa as $penyakit_id => $data) {
    //         $hasil_diagnosa[$penyakit_id]['solusi'] = $solusi_penyakit[$penyakit_id];
    //     }

    //     // Memperbarui hasil_diagnosa dalam variabel $result
    //     $result['hasil_diagnosa'] = $hasil_diagnosa;
    ...
    public function diagnosa(Request $request)
    {
        ...
        // Mendapatkan data solusi dari tabel penyakit berdasarkan id penyakit
        $penyakit_terdiagnosa = Penyakit::whereIn('id', $penyakit_ids)->get(['id', 'solusi']);

        // Memasukkan data solusi ke dalam array hasil diagnosa
        foreach ($hasil_diagnosa as $penyakit_id => &$data) {
            $solusi = $penyakit_terdiagnosa->where('id', $penyakit_id)->pluck('solusi')->first();
            $data['solusi'] = $solusi;
        }
